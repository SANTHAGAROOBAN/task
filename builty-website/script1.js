...
var backstyle=document.querySelector(".backstyle");
...
function leftpre(){
    ...
    if(count--){
        ...
        backstyle.classList.remove("backstyle");
        backstyle.classList.add("backstyle1");
    } 
    else{
        info1.classList.add("info_h1"); 
        info1.classList.remove("info_h1sample");
        infopara.classList.add("info_para");
        infopara.classList.remove("info_parasample");
        infos.classList.add("start-consulting");
        infos.classList.remove("start-consultingsample");
        backstyle.classList.add("backstyle");
        backstyle.classList.remove("backstyle1");
    }
